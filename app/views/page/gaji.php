    <div class="container mt-3">
        ...
        <div class="jumbotron ">
            ...
            <hr class="my-4">
            <a href="<?= BASEURL ?>/user/tambah_gaji"><button class="btn btn-primary mb-3">Tambah
                    Data</button></a>
                    ...
                    <tbody class="table-light">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <?php } else { ?>
                                <a href="<?= BASEURL ?>/user/set_bayar/<?= $data['id'] ?>"><button
                            ...
                            <td> <?php if ($data['status'] == 1) { ?>
                                ...
                                <?php } else { ?>
                                <a href="<?= BASEURL ?>/user/ubah_gaji/<?= $data['id'] ?>"><button
                                        class="btn btn-warning">Ubah</button></a>
                                <a href="<?= BASEURL ?>/user/hapus_gaji/<?= $data['id'] ?>"><button
